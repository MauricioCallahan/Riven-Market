...
class StatWeights:
    ...
    def compute_stat_weights(
        ...
        sorted_auctions = sorted(
            auctions,
            key=lambda a: StatWeights.get_effective_price(a) or 0.0,
            reverse=True,
        )
...
get_effective_price  = StatWeights.get_effective_price
compute_stat_weights = StatWeights.compute_stat_weights
